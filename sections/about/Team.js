      ...
      <Container>
        ...
        <Row className="align-items-center justify-content-center">
          <Col sm="6" md="5" lg="4" className="mt-3 mt-lg-4">
            <TeamCard userImg={imgU1} title="Anthony Lin">
              Founder and CEO
              <Text style={{ color: "black" }}>
                Anthony taught over 100 student programming classes throughout
                the bay, and is looking to bring an immersive online learning
                experience to inspire the next generation through code
              </Text>
            </TeamCard>
          </Col>
          {/* <Col sm="6" md="5" lg="4" className="mt-3 mt-lg-4">
